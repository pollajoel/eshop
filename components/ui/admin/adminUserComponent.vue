...
<div class="overflow-x-auto w-full" >
  <div class="bg-white shadow-md rounded my-6">
    ...
    <table class="min-w-max w-full table-auto">
      <thead>
      <tr>
           <th colspan="1"><succesArlete :successmessage="successmessage" v-if="successmessage"/></th>
      </tr>
      <tr>
        <th class="w-full" colspan="1"><ErrorAlerte :errormessage="errorMessage" v-if="errorMessage"class="w-full" /></th>
      </tr>
      <tr>
      ...
      <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
        ...
        <th class="py-3 px-6 text-center">Mot de passe</th>
