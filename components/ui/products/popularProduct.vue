            ...
            <div class="bg-white shadow-lg hover:shadow-xl rounded-lg ">
              ...
              <div class="flex justify-between items-start px-2 pt-2">
                ...
                <div class="p-2 text-right">
                  ...
                  <div class="text-xs text-gray-500 line-through font-poppins">$50</div>
                </div>
              </div>
              <div class="flex justify-center items-center px-2 pb-2">
                <div class="w-1/2 p-2">
                ...
                <div class="w-1/2 p-2">
                  <button class="block w-full bg-white hover:bg-gray-100 text-teal-500 border-2 border-teal-500 px-3 py-2 rounded uppercase font-poppins font-medium text-xs">
                    Add to cart
                  </button>
                </div>
              </div>
...
export default {
  ...
  methods:{
    HandleFavoris:function (product){
      ...
      const isPresent = favorites.map(e=>e._id).indexOf(product._id);
    ...
    addToCart:function (product){
      ...
      const isPresent = cart.map(e=>e._id).indexOf(product._id);
